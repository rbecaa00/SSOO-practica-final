...
int main(int argc, char *argv[]){
	...
	int aux[2] = {0, 1};
	pthread_create(&recepcionista_1, NULL, accionesRecepcionista, &aux);
	aux[1] = 2;
	pthread_create(&recepcionista_2, NULL, accionesRecepcionista, &aux);
	pthread_create(&recepcionista_3, NULL, accionesRecepcionista, &aux);
